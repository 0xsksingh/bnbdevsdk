...
// @notice This file helps us to spin up a new project with BNB-Dev-SDK
export async function createApp({
  ...
  console.log(`Spinning up a new BNB project in ${chalk.green(root)}.`);
  console.log();
  ...
  try {
    ...
    await retry(
      () => downloadAndExtractRepo(root, { name: "bnbdevsdk", filePath: "" }),
      {
        retries: 3,
      }
    );
